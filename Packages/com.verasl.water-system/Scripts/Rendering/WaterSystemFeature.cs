...
namespace WaterSystem
{
    public class WaterSystemFeature : ScriptableRendererFeature
    {
        ...
        class WaterFxPass : ScriptableRenderPass
        {
            ...
            private int waterFXShaderPropertyId;
            #else
            ...
            {
                #if USE_RTHANDLE
                m_WaterFX = k_CameraTarget;
                m_WaterFX = RTHandles.Alloc("_WaterFXMap", "_WaterFXMap");
                waterFXShaderPropertyId = Shader.PropertyToID(m_WaterFX.name);
                #else
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                #if USE_RTHANDLE
                cmd.GetTemporaryRT(waterFXShaderPropertyId, cameraTextureDescriptor, FilterMode.Bilinear);
            ...
            public override void OnCameraCleanup(CommandBuffer cmd) 
            {
                ...
                #if USE_RTHANDLE
                cmd.ReleaseTemporaryRT(waterFXShaderPropertyId);
                #else
